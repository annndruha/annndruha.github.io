...
* ### Преподаватель курса по нейронным сетям
    ...
    *2020-2022 MSU.AI (МГУ имени М.В.Ломоносова)*

    * Написал и преподавал [годовой курс](https://msu.ai) по нейронным сетям аспирантам и магистрам МГУ.
...
* ### Руководитель команды разработчиков PWA-приложения
    ...
    * Разработал микросервисную архитектуру (Docker, Python, Fast-API, Kafka, Type-script,
PostgreSQL и другие)
